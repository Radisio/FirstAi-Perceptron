...
void Demo::classificationDonneeNonLineairementSeparableTable2_10() {
    ...
    switch (returnedVal) {
        case 0:
        {
            ...
            std::vector<std::vector<Data>> output = data.getColumn(2);
            std::vector<Layer> layers({Layer(1, new SeuilIdentite(), new GeneratorOnly0())});
            DGModel model(entry, layers, output, 0.0015,0.37);
            model.initNbSynapticWeight();
            model.debugLog();
            model.debugSynapseWeight();
            model.fit(1000);
        ...
        case 1:
        {
            ...
            std::vector<std::vector<Data>> output = data.getColumn(2);
            std::vector<Layer> layers({Layer(1, new SeuilIdentite(), new GeneratorOnly0())});
            AdalineModel model(entry, layers, output, 0.0015,0.375);
            model.initNbSynapticWeight();
            model.debugLog();
            model.debugSynapseWeight();
            model.fit(1000);
...
void Demo::regressionLineaireTable2_11() {
    ...
    switch (returnedVal) {
        case 0:
        {
            ...
            std::vector<Layer> layers({Layer(1, new SeuilIdentite(), new GeneratorOnly0())});
            DGModel model(entry, layers, output, 0.000167,0.6);
            model.initNbSynapticWeight();
            model.debugLog();
            model.debugSynapseWeight();
            model.fit(4000);
        ...
        case 1:
        {
            ...
            std::vector<std::vector<Data>> output = data.getColumn(1);
            std::vector<Layer> layers({Layer(1, new SeuilIdentite(), new GeneratorOnly0())});
            AdalineModel model(entry, layers, output, 0.00014,0.6);
            model.initNbSynapticWeight();
            model.debugLog();
            model.debugSynapseWeight();
            model.fit(8000);
...
void Demo::classification3ClassesTable3_1() {
    ...
    switch (returnedVal) {
        case 0:
        {
            ...
            DGModel model(entry, layers, output, 0.0001,0.01);
            model.initNbSynapticWeight();
            model.debugLog();
            model.debugSynapseWeight();
            model.fit(300);
        ...
        case 1:
        {
            ...
            std::vector<std::vector<Data>> output = data.getColumns(2,4);
            std::vector<Layer> layers({Layer(3, new SeuilIdentite(), new GeneratorOnly0())});
            AdalineModel model(entry, layers, output, 0.03);
            model.initNbSynapticWeight();
            model.debugLog();
            model.debugSynapseWeight();
            model.fit(300);
...
void Demo::classification4ClassesTable3_5() {
    ...
    switch (returnedVal) {
        case 0:
        {
            ...
            /*std::vector<double> x = Util::dataTabToDoubleVector(data.getColumn(0), 0);
            std::vector<double> y = Util::dataTabToDoubleVector(data.getColumn(1), 0);
            Plot plot = SciplotHelper::drawRegressionCurve(x,y,&model,"Régression linéaire (Droites) (Descente du gradient) (Table 2.11)");
            Plot plot2 = SciplotHelper::drawBoundariesDecisionZones(x,y,&model,"Régression linéaire (Zones) (Descente du gradient) (Table 2.11)");
            Figure fig = {{plot,plot2}};
            fig.show();
            fig.save("SavedPlot/DGtable_3_5_plot.pdf");*/
            break;
        }
        case 1:
        {
            ...
            std::vector<std::vector<Data>> output = data.getColumns(25,28);
            std::vector<Layer> layers({Layer(4, new SeuilIdentite(), new GeneratorOnly0())});
            AdalineModel model(entry, layers, output, 0.001,0.05);
            model.initNbSynapticWeight();
            model.debugLog();
            model.debugSynapseWeight();
            model.fit(300);
          ...
          /*  std::vector<double> x = Util::dataTabToDoubleVector(data.getColumn(0), 0);
            ...
            Plot plot = SciplotHelper::drawRegressionCurve(x,y,&model,"Régression linéaire (Adaline) (Table 2.11)");
            plot.show();
            plot.save("SavedPlot/Adatable_3_5_plot.pdf");*/
            break;
        }
    }
}
...
void Demo::operateurLogiqueXorTable4_3() {
    ...
    switch (returnedVal) {
        case 0:
        {
            ...
            DGModel model(entry, layers, output, 0.8,0.001);
            model.initNbSynapticWeight();
            model.debugLog();
            model.debugSynapseWeight();
            model.fit(2000);
        ...
        case 1:
        {
            ...
            std::vector<std::vector<Data>> entry = data.getColumns(0,1);
            std::vector<std::vector<Data>> output = data.getColumn(2);
            std::vector<Layer> layers({Layer(3, new SeuilSigmoide(1), new GeneratorNormalLaw(0.0,1.0)),Layer(1, new SeuilSigmoide(1), new GeneratorNormalLaw(0.0,1.0))});
            AdalineModel model(entry, layers, output, 0.8);
            model.initNbSynapticWeight();
            model.debugLog();
            model.debugSynapseWeight();
            model.fit(2000);
...
void Demo::classification2ClassesNonLineairementSeparableTable4_12() {
    ...
    switch (returnedVal) {
        ...
        case 1:
        {
            AdalineModel model(entry, layers, output, 0.5);
            model.initNbSynapticWeight();
            model.debugLog();
            model.debugSynapseWeight();
            model.fit(300);
